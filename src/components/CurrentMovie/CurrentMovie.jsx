...
import { settings, settings2, settings3 } from '../../constants/_slider'
              ...
              {currentMovie.runtime ? (
                ...
                <p className='text-white text-sm md:text-xl'>
                  ...
                  {en
                    ...
                    ? 'сезон '
                    : currentMovie.number_of_seasons > 1 &&
                      currentMovie.number_of_seasons <= 4
                    ? 'сезона '
                    : 'сезонов'}
                  / {currentMovie.number_of_episodes}
                  {en
                    ? 'episodes'
                    : currentMovie.number_of_episodes === 1
                    ? 'серия'
                    : currentMovie.number_of_seasons > 1 &&
                      currentMovie.number_of_seasons < 5
                    ? 'серии'
                    : 'серий'}
                </p>
              )}
      ...
      <div className='mt-[5px] flex justify-center md:block'>
        ...
        {currentMovie.videos?.length === 1 && (
          <iframe
            title='trailer'
            frameborder='0'
            src={'https://www.youtube.com/embed/' + currentMovie.videos[0]?.key}
            className='w-[350px] h-[220px] md:w-[600px] md:h-[300px]'
          />
        )}
        {!currentMovie && (
          <Slider
            {...settings}
            className='max-w-[350px] md:max-w-[600px] cursor-grab'
          >
